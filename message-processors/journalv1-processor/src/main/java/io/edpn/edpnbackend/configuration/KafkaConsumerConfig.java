...
public interface KafkaConsumerConfig {
    ...
    class EddnJsonKafkaConsumerConfig {
        ...
        @Bean
        public ConcurrentKafkaListenerContainerFactory<String, JsonNode> eddnJournalKafkaListenerContainerFactory(EddnJsonKafkaConsumerConfig kafkaConfig) {
            return kafkaConfig.kafkaListenerContainerFactory("journal");
        }
    }
}
